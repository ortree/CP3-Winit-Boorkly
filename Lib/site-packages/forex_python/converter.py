...
class CurrencyCodes:
    ...
    def get_some_code_list(self):
        currency_code_list =[]
        file_path = os.path.dirname(os.path.abspath(__file__))
        with open(file_path + '/raw_data/currencies.json') as f:
            currency_data = json.loads(f.read())
        for code in currency_data:
            if(code['cc'] == 'USD' or code['cc'] == 'AUD'or code['cc'] == 'THB'):
                currency_code_list.append(code['cc'])
...
get_code_list = _CURRENCY_CODES.get_some_code_list